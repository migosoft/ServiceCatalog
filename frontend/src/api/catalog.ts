...
export const catalogApi = {
  ...
  createNode: (data: { type: string; name: string; description?: string; operatingSystem?: string; owner?: string }) =>
    api.post<NodeDto>('/api/nodes', data).then(r => r.data),
  updateNode: (id: string, data: { name: string; description?: string; operatingSystem?: string; owner?: string }) =>
